 ...
 * on 2014-09-21 at 08:33:13 UTC 
 * Modify at your own risk.
 */

package com.uet.mhst.itemendpoint;
...
public class Itemendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * An accessor for creating requests from the ItemEndpoint collection.
   *
   * <p>The typical use is:</p>
   * <pre>
   *   {@code Itemendpoint itemendpoint = new Itemendpoint(...);}
   *   {@code Itemendpoint.ItemEndpoint.List request = itemendpoint.itemEndpoint().list(parameters ...)}
   * </pre>
   *
  ...
  /**
   * The "itemEndpoint" collection of methods.
   */
  public class ItemEndpoint {

    /**
     * Create a request for the method "itemEndpoint.removeItem".
     *
    ...
    /**
     * Create a request for the method "itemEndpoint.updateItem".
     *
     * This request holds the parameters needed by the itemendpoint server.  After setting any optional
     * parameters, call the {@link UpdateItem#execute()} method to invoke the remote operation.
     *
     * @param content the {@link com.uet.mhst.itemendpoint.model.Item}
     * @return the request
     */
    public UpdateItem updateItem(com.uet.mhst.itemendpoint.model.Item content) throws java.io.IOException {
      UpdateItem result = new UpdateItem(content);
      initialize(result);
      return result;
    }

    public class UpdateItem extends ItemendpointRequest<com.uet.mhst.itemendpoint.model.Item> {
       ...
       * @since 1.13
       */
      protected UpdateItem(com.uet.mhst.itemendpoint.model.Item content) {
        super(Itemendpoint.this, "PUT", REST_PATH, content, com.uet.mhst.itemendpoint.model.Item.class);
      }
   ...
   *
   * @param idstt
   * @param content the {@link com.uet.mhst.itemendpoint.model.Comment}
   * @return the request
   */
  public Comment comment(java.lang.Long idstt, com.uet.mhst.itemendpoint.model.Comment content) throws java.io.IOException {
    Comment result = new Comment(idstt, content);
    initialize(result);
    return result;
  }

  public class Comment extends ItemendpointRequest<Void> {

    private static final String REST_PATH = "comment/{idstt}";
     ...
     * @since 1.13
     */
    protected Comment(java.lang.Long idstt, com.uet.mhst.itemendpoint.model.Comment content) {
      super(Itemendpoint.this, "POST", REST_PATH, content, Void.class);
      this.idstt = com.google.api.client.util.Preconditions.checkNotNull(idstt, "Required parameter idstt must be specified.");
    }
    ...
    @com.google.api.client.util.Key
    private java.lang.Long idstt;

    /**

     */
    public java.lang.Long getIdstt() {
      return idstt;
    }

    public Comment setIdstt(java.lang.Long idstt) {
      this.idstt = idstt;
      return this;
    }
  ...
  public class GetItem extends ItemendpointRequest<com.uet.mhst.itemendpoint.model.Item> {
    ...
    protected GetItem(java.lang.Long id) {
      super(Itemendpoint.this, "GET", REST_PATH, null, com.uet.mhst.itemendpoint.model.Item.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }
   ...
   * @return the request
   */
  public InsertItem insertItem(com.uet.mhst.itemendpoint.model.Item content) throws java.io.IOException {
    InsertItem result = new InsertItem(content);
    initialize(result);
    return result;
  }

  public class InsertItem extends ItemendpointRequest<com.uet.mhst.itemendpoint.model.Item> {
     ...
     * @since 1.13
     */
    protected InsertItem(com.uet.mhst.itemendpoint.model.Item content) {
      super(Itemendpoint.this, "POST", REST_PATH, content, com.uet.mhst.itemendpoint.model.Item.class);
    }
  ...
  public class ListItem extends ItemendpointRequest<com.uet.mhst.itemendpoint.model.CollectionResponseItem> {
     ...
     */
    protected ListItem() {
      super(Itemendpoint.this, "GET", REST_PATH, null, com.uet.mhst.itemendpoint.model.CollectionResponseItem.class);
    }
    ...
    public ListItem setDistance(java.lang.Double distance) {
      this.distance = distance;
      return this;
    }

    @com.google.api.client.util.Key
    private com.google.api.client.util.DateTime timeAfter;

    /**

     */
    public com.google.api.client.util.DateTime getTimeAfter() {
      return timeAfter;
    }

    public ListItem setTimeAfter(com.google.api.client.util.DateTime timeAfter) {
    ...
    public ListItem setLon(java.lang.Double lon) {
      this.lon = lon;
      return this;
    }
    ...
    public ListItem setLat(java.lang.Double lat) {
      this.lat = lat;
      return this;
    }

    @com.google.api.client.util.Key
    private com.google.api.client.util.DateTime timeBefore;

    /**

     */
    public com.google.api.client.util.DateTime getTimeBefore() {
      return timeBefore;
    }

    public ListItem setTimeBefore(com.google.api.client.util.DateTime timeBefore) {
   ...
   * @return the request
   */
  public Remove remove(java.lang.Long idstt, java.lang.String idfb) throws java.io.IOException {
    Remove result = new Remove(idstt, idfb);
    initialize(result);
    return result;
  }

  public class Remove extends ItemendpointRequest<Void> {

    private static final String REST_PATH = "remove/{idstt}/{idfb}";
     ...
     * @since 1.13
     */
    protected Remove(java.lang.Long idstt, java.lang.String idfb) {
      super(Itemendpoint.this, "DELETE", REST_PATH, null, Void.class);
      this.idstt = com.google.api.client.util.Preconditions.checkNotNull(idstt, "Required parameter idstt must be specified.");
      this.idfb = com.google.api.client.util.Preconditions.checkNotNull(idfb, "Required parameter idfb must be specified.");
    }
    ...
    public Remove setIdstt(java.lang.Long idstt) {
      this.idstt = idstt;
      return this;
    }
    ...
    public Remove setIdfb(java.lang.String idfb) {
      this.idfb = idfb;
      return this;
    }
  ...
  /**
   * Create a request for the method "vote".
   *
   * This request holds the parameters needed by the itemendpoint server.  After setting any optional
   * parameters, call the {@link Vote#execute()} method to invoke the remote operation.
   *
   * @param idstt
   * @param content the {@link com.uet.mhst.itemendpoint.model.Vote}
   * @return the request
   */
  public Vote vote(java.lang.Long idstt, com.uet.mhst.itemendpoint.model.Vote content) throws java.io.IOException {
    Vote result = new Vote(idstt, content);
    initialize(result);
    return result;
  }

  public class Vote extends ItemendpointRequest<Void> {

    private static final String REST_PATH = "vote/{idstt}";

    /**
     * Create a request for the method "vote".
     *
     * This request holds the parameters needed by the the itemendpoint server.  After setting any
     * optional parameters, call the {@link Vote#execute()} method to invoke the remote operation. <p>
     * {@link Vote#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @param idstt
     * @param content the {@link com.uet.mhst.itemendpoint.model.Vote}
     * @since 1.13
     */
    protected Vote(java.lang.Long idstt, com.uet.mhst.itemendpoint.model.Vote content) {
      super(Itemendpoint.this, "POST", REST_PATH, content, Void.class);
      this.idstt = com.google.api.client.util.Preconditions.checkNotNull(idstt, "Required parameter idstt must be specified.");
    }

    @Override
    public Vote setAlt(java.lang.String alt) {
      return (Vote) super.setAlt(alt);
    }

    @Override
    public Vote setFields(java.lang.String fields) {
      return (Vote) super.setFields(fields);
    }

    @Override
    public Vote setKey(java.lang.String key) {
      return (Vote) super.setKey(key);
    }

    @Override
    public Vote setOauthToken(java.lang.String oauthToken) {
      return (Vote) super.setOauthToken(oauthToken);
    }

    @Override
    public Vote setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (Vote) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public Vote setQuotaUser(java.lang.String quotaUser) {
      return (Vote) super.setQuotaUser(quotaUser);
    }

    @Override
    public Vote setUserIp(java.lang.String userIp) {
      return (Vote) super.setUserIp(userIp);
    }
    ...
    public Vote setIdstt(java.lang.Long idstt) {
      this.idstt = idstt;
      return this;
    }

    @Override
    public Vote set(String parameterName, Object value) {
      return (Vote) super.set(parameterName, value);
    }
  }
